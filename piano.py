...
starting_speed = int(sys.argv[3]) if len(sys.argv) > 3 else 3  # Increase starting speed
aceleration = 0.00000075  # Increase acceleration
if dificulty == "normal":
    aceleration *= 10
if dificulty == "hard":
    aceleration *= 75
...
while True:
    ...
    if gameover:
        ...
        myfont = pygame.font.SysFont("Times new Roman", 28, bold=True)
        textsurface = myfont.render(txt, False, (0, 0, 0))
